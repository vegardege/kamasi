 ...
 * chords and use existing chords as base when possible.
 * 
 * Chords are grouped according to the lists on:
 *   https://en.wikipedia.org/wiki/Chord_(music)
 *   https://en.wikipedia.org/wiki/Chord_letters
 */
const TRIADS: Record<string, readonly IntervalNotation[]> = {
  'major':      ['P1', 'M3', 'P5'],
  'minor':      ['P1', 'm3', 'P5'],
  'augmented':  ['P1', 'M3', 'A5'],
  'diminished': ['P1', 'm3', 'd5'],
...
const SIXTH: Record<string, IntervalNotation[]> = {
  'major sixth': TRIADS['major']!.concat('M6'),
  'minor sixth': TRIADS['minor']!.concat('M6'),
}

const SEVENTH: Record<string, IntervalNotation[]> = {
...
const NINTH: Record<string, IntervalNotation[]> = {
...
const ELEVENTH: Record<string, IntervalNotation[]> = {
...
export const CHORDS: Readonly<Record<string, readonly IntervalNotation[]>> = Object.assign({},
  TRIADS,
  SIXTH,
  SEVENTH,
  NINTH,
...
export const CHORD_ALIAS: Readonly<Record<string, string>> = {
  // Triads
  '': 'major',
  'M': 'major',
  'maj': 'major',
